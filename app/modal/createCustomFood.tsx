...
export default function CreateCustomFoodScreen() {
  ...
  const handleSave = async () => {
    if (!foodName || !calories) {
      Alert.alert(
        t("missingFields") as string,
        t("fillRequiredFields") as string,
      );
      return;
    }
    if (!servingSize.trim()) {
  ...
  return (
    ...
    >
      <Stack.Screen
        options={{
          title: t("createCustomFood") as string,
          headerShown: false,
        }}
      />
        ...
        <View style={[styles.section, { direction: isRTL ? "rtl" : "ltr" }]}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder={t("servingSizePlaceholder") as string}
              placeholderTextColor={colors.placeholder}
            />
          </View>
        </View>
                ...
                <View
                  style={[
                    styles.macroInfo,
                    {
                      ...
                      paddingRight:
                        isRTL && Platform.OS === "ios" ? responsiveWidth(3) : 0,
                    },
                  ]}
                >
                  ...
                  <Text
                    style={[styles.macroUnit, { color: colors.placeholder }]}
                  >
                    {macro.unit}
                  </Text>
                </View>
