...
import { Activity, ChevronRight, Edit3, Save, Target, User } from 'lucide-react-native';
        ...
        {user && (
          <View style={styles.section}>
            <View style={[styles.sectionHeader, isRTL && styles.rtlRow]}>
              ...
              <Text style={[styles.sectionTitle, isRTL && styles.rtlText]}>{t('profileInformation')}</Text>
            </View>

            <View style={styles.userInfo}>
              <Text style={[styles.userInfoLabel, isRTL && styles.rtlText]}>{t('signedInAs')}</Text>
              <Text style={[styles.userInfoValue, isRTL && styles.rtlText]}>
  {user.displayName || "User"}
</Text>
              <Text style={[styles.userInfoEmail, isRTL && styles.rtlText]}>{user.email}</Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, isRTL && styles.rtlText]}>{t('quickUpdate')}</Text>
          
          <View style={styles.inputGroup}>
            <Text style={[styles.inputLabel, isRTL && styles.rtlText]}>{t('weight')}</Text>
            <TextInput
              style={[styles.input, isRTL && styles.rtlInput]}
              value={localSettings.weight === 0 ? '' : localSettings.weight.toString()}
              onChangeText={(value) => {
                if (value === '') {
            ...
            >
              ...
              <View style={styles.modalSection}>
                    ...
                    <View style={styles.inputGroup}>
                      ...
                      >
                        <Text style={styles.pickerButtonText}>{profileData.height} cm</Text>
                      </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.inputGroup}>
                      ...
                      >
                        <Text style={styles.pickerButtonText}>{profileData.weight} kg</Text>
                      </TouchableOpacity>
                    </View>
                      ...
                      <View style={styles.optionsContainer}>
                        {GENDERS.map((gender) => (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.optionCard,
                              profileData.gender === gender.key && styles.optionCardSelected
                            ]}
                            onPress={() => updateProfileField('gender', gender.key)}
                          >
                            <Text style={[
                              styles.optionTitle,
                              profileData.gender === gender.key && styles.optionTitleSelected
                            ]}>
                              {gender.label}
                            </Text>
                          </TouchableOpacity>
                  ...
                  <View style={styles.modalSection}>
                      ...
                      <View style={styles.optionsContainer}>
                        {ACTIVITY_LEVELS.map((level) => (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.optionCard,
                              profileData.activityLevel === level.key && styles.optionCardSelected
                            ]}
                            onPress={() => updateProfileField('activityLevel', level.key)}
                          >
                            <Text style={[
                              styles.optionTitle,
                              profileData.activityLevel === level.key && styles.optionTitleSelected
                            ]}>
                              {level.label}
                            </Text>
                            <Text style={[
                              styles.optionDescription,
                              profileData.activityLevel === level.key && styles.optionDescriptionSelected
                            ]}>
                              {level.description}
                            </Text>
                          </TouchableOpacity>
                      ...
                      <View style={styles.optionsContainer}>
                        {GOALS.map((goal) => (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.optionCard,
                              profileData.goal === goal.key && styles.optionCardSelected
                            ]}
                            onPress={() => updateProfileField('goal', goal.key)}
                          >
                            <Text style={[
                              styles.optionTitle,
                              profileData.goal === goal.key && styles.optionTitleSelected
                            ]}>
                              {goal.label}
                            </Text>
                            <Text style={[
                              styles.optionDescription,
                              profileData.goal === goal.key && styles.optionDescriptionSelected
                            ]}>
                              {goal.description}
                            </Text>
                          </TouchableOpacity>
                    ...
                    {(profileData.goal === 'lose_weight' || profileData.goal === 'gain_weight') && (
                      <View style={styles.inputGroup}>
                        ...
                        >
                          <Text style={styles.pickerButtonText}>{profileData.targetWeight} kg</Text>
                        </TouchableOpacity>
                      </View>
                    )}
                  </View>
