...
export const translations = {
  en: {
    ...
    deleteFoodMessage: "Remove {food} from this day?",
    ...
    activePremiumMember: "Active Premium Member",
    planType: "Plan Type",
    cost: "Cost",
    renewalDate: "Renewal Date",
    premiumPlan: "Premium Plan",
    notAvailable: "N/A",
    upgradeAndSave50: "UPGRADE & SAVE 50%",
    switchToYearlyPlan: "Switch to Yearly Plan",
    yearlyUpgradeDescription:
    ...
    alreadyOnYearlyPlan: "You are already on the Yearly Plan.",
    yearlyPlanUnavailable:
      "Yearly plan is currently not available. Please try again later.",
    upgradedToYearlySuccessfully: "Successfully upgraded to the Yearly Plan!",
    upgradeVerificationFailed: "Upgrade verification failed.",
    ...
    alignMealWithinBrackets: "Align meal within the brackets",
    logThisMealAs: "Log this meal as",
    confidence: "confidence",
    retake: "Retake",
    totalForThisFood: "Total for this food",
    estimatedMealImageNote: "Estimated from the submitted meal image.",
    initializingCamera: "Initializing camera...",
    scanningImage: "Scanning image...",
    detectingFoodMacros: "Detecting food and estimating macros...",
    mealDetected: "Meal detected",
    estimatingMacros: "Estimating calories, protein, carbs, and fat...",
    failedToScanMeal: "Failed to scan this meal.",
    couldNotReadCapturedImage: "Could not read the captured image.",
  ...
  ar: {
    ...
    deleteFoodMessage: "هل تريد حذف {food} من هذا اليوم؟",
    ...
    activePremiumMember: "عضو مميز نشط",
    planType: "نوع الخطة",
    cost: "التكلفة",
    renewalDate: "تاريخ التجديد",
    premiumPlan: "خطة مميزة",
    notAvailable: "غير متوفر",
    upgradeAndSave50: "رقّ واشترك سنوياً ووفر 50٪",
    switchToYearlyPlan: "التحويل إلى الخطة السنوية",
    yearlyUpgradeDescription:
      "احصل على نفس مزايا العضوية المميزة لمدة سنة كاملة ووفر 50٪ مقارنة بالخطة الشهرية.",
    monthlyLabel: "شهري",
    yearlyLabel: "سنوي",
    perMonthShort: "/شهر",
    perYearShort: "/سنة",
    ...
    perYear: "سنة",
    only: "فقط",
    upgradeToYearly: "الترقية إلى السنوي",
    noActiveSubscription: "لا يوجد اشتراك نشط",
    inactiveSubscriptionDescription:
      "أنت حالياً على الخطة المجانية أو غير النشطة. اشترك لفتح جميع الميزات.",
    alreadyOnYearlyPlan: "أنت مشترك بالفعل في الخطة السنوية.",
    yearlyPlanUnavailable:
      "الخطة السنوية غير متوفرة حالياً. يرجى المحاولة لاحقاً.",
    upgradedToYearlySuccessfully: "تمت الترقية إلى الخطة السنوية بنجاح!",
    upgradeVerificationFailed: "فشل التحقق من الترقية.",
    failedToUpgradeSubscription: "فشل ترقية الاشتراك.",
    failedToRestorePurchases: "فشل استعادة المشتريات.",
    ...
    alignMealWithinBrackets: "ضع الوجبة داخل الإطار",
    logThisMealAs: "سجّل هذه الوجبة كـ",
    confidence: "ثقة",
    retake: "إعادة الالتقاط",
    totalForThisFood: "إجمالي هذا الطعام",
    estimatedMealImageNote: "تقدير بناءً على صورة الوجبة المرسلة.",
    initializingCamera: "جاري تهيئة الكاميرا...",
    scanningImage: "جاري مسح الصورة...",
    detectingFoodMacros: "جاري التعرف على الطعام وتقدير الماكروز...",
    mealDetected: "تم اكتشاف الوجبة",
    estimatingMacros: "جاري تقدير السعرات والبروتين والكربوهيدرات والدهون...",
    failedToScanMeal: "فشل مسح هذه الوجبة.",
    couldNotReadCapturedImage: "تعذر قراءة الصورة الملتقطة.",
